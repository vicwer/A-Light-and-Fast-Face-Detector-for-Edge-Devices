...
class PredictCaffe(object):
    ...
    def __init__(self,
        ...
        self.constant = [i / 2.0 for i in self.receptive_field_list] # [64, 128, 256]
    ...
    def predict(self, image, resize_scale=1, score_threshold=0.8, top_k=100, NMS_threshold=0.3, NMS_flag=True, skip_scale_branch_list=[]):
        ...
        out_key = ['slice_axis16_1', 'conv11_3_bbox',
                   'slice_axis17_1', 'conv14_3_bbox',
                   'slice_axis18_1', 'conv17_3_bbox',
                   'slice_axis19_1', 'conv20_3_bbox']
        for key in out_key:
...
def run_prediction_pickle():
    ...
    symbol_file_path = './configuration_64_512_16L_3scales_v1_2019-09-29-13-41-44/deploy.prototxt'
    model_file_path = './configuration_64_512_16L_3scales_v1_2019-09-29-13-41-44/residual.caffemodel'
    my_predictor = PredictCaffe(caffe=caffe,
                           symbol_file_path=symbol_file_path,
                           model_file_path=model_file_path,
                           receptive_field_list=cfg.param_receptive_field_list, # [128, 256, 512]
                           receptive_field_stride=cfg.param_receptive_field_stride, # [16, 32, 64]
                           bbox_small_list=cfg.param_bbox_small_list, # [64, 128, 256]
                           bbox_large_list=cfg.param_bbox_large_list, # [128, 256, 512]
                           receptive_field_center_start=cfg.param_receptive_field_center_start, # [15, 31, 63]
...
def run_prediction_folder():
    ...
    test_folder = '../accuracy_evaluation/test_images/'
    ...
    symbol_file_path = './configuration_30_320_20L_4scales_v1_2019-09-11-19-25-41/symbol_30_320_20L_4scales_v1_deploy.prototxt'
    model_file_path = './configuration_30_320_20L_4scales_v1_2019-09-11-19-25-41/train_30_320_20L_4scales_v1_iter_500000.caffemodel'
    my_predictor = PredictCaffe(caffe=caffe,
                           symbol_file_path=symbol_file_path,
                           model_file_path=model_file_path,
