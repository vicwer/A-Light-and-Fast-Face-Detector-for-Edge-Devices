...
class PredictCaffe(object):
    ...
    def predict(self, image, resize_scale=1, score_threshold=0.8, top_k=100, NMS_threshold=0.3, NMS_flag=True, skip_scale_branch_list=[]):
        ...
        out_key = ['slice_axis12_1', 'conv10_3_bbox',
                   'slice_axis13_1', 'conv13_3_bbox',
                   'slice_axis14_1', 'conv16_3_bbox']
        for key in out_key:
...
def run_prediction_folder():
    ...
    symbol_file_path = './configuration_64_512_16L_3scales_v1_2019-09-29-13-41-44/symbol_64_512_16L_3scales_v1_deploy.prototxt'
    model_file_path = './configuration_64_512_16L_3scales_v1_2019-09-29-13-41-44/train_64_512_16L_3scales_v1_iter_1000000.caffemodel'
    my_predictor = PredictCaffe(caffe=caffe,
                           symbol_file_path=symbol_file_path,
                           model_file_path=model_file_path,
                           receptive_field_list=cfg.param_receptive_field_list,
